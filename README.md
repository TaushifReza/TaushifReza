...
<div >
	...
	<img width="50" src="![My Skills](https://skillicons.dev/icons?i=cs,py,java,js,dotnet,dart,django,css,flutter,html,mysql,postgres,sqlite,bootstrap,docker,git,github,postman,vscode,visualstudio,eclipse)](https://skillicons.dev)"/>
</div>
